import 'jquery-knob';
import './clock.html';
//import '../stylesheets/activeclock.scss';
...
Template.clock.onDestroyed(() => {
	//$('#datepicker').datepicker('destroy');
});
Template.clock.helpers({
	timeanimate(){
		if (Collections.Timers.find({userId: Meteor.userId(), timeStarted: {$exists: true}}).count()) return 's-animate';
	},
